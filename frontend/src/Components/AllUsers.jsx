...
function AllUsers() {
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto min-h-screen">
      ...
      <div className="container mx-auto px-2 py-2 relative z-10 min-h-screen">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-16 gap-y-8 justify-items-center mt-20">
          {users.map((user) => (
