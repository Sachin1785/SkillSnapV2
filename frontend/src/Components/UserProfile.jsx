          ...
          <div className="sidebar">
            ...
            <div className="profile-details-section">
              ...
              <div className="social-media-links">
                {user.instagram && (
                  <LinkPreview url={user.instagram} className="text-[#E4405F]" width={300} height={200}>
                ...
                {user.linkedin && (
                  <LinkPreview url={user.linkedin} className="text-[#0077B5]" width={300} height={200}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                {user.github && (
                  <LinkPreview url={user.github} className="text-white" width={300} height={200}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
