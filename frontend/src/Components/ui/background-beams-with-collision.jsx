...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    (<div
      ref={parentRef}
      className={cn(
        "h-96 md:h-[40rem] bg-gradient-to-b from-black to-gray-950 dark:from-black dark:to-gray-950 relative flex items-center w-full justify-center overflow-hidden",
