...
function EditProfile() {
  ...
  useEffect(() => {
    if (
      JSON.stringify(profileData) !== JSON.stringify(initialProfileData.current)
    ) {
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
              {hasUnsavedChanges && (
                <p style={{ color: "#FCD34D" }}>You have unsaved changes.</p>
              )}
              {saveStatus && <p style={{ color: "#34D399" }}>{saveStatus}</p>}
            </div>
          </div>
